...
app.post("/ufo/upload", upload.single("file"), (req, res) => {
  ...
  // Removing this dangerous endpoint that allows arbitrary file uploads
});
  ...
  if (contentType === "application/json") {
    ...
    try {
      const xmlDoc = libxmljs.parseXml(req.body, {
        replaceEntities: false, // Prevent XXE attacks
      ...
      // Remove dangerous command execution feature
      if (
